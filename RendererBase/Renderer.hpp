...
namespace Alius {
    ...
    using RendererModuleCreator = std::function<std::unique_ptr<Renderer>(size_t, size_t, const char*)>;
     ...
     * should be unique_ptr<Renderer>). Is of type std::function<std::unique_ptr<Renderer>(size_t, size_t, const char*)>.
